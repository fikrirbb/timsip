                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
												...
												<th>Cash Penjualan</th>
												<th>Kembali Penjualan</th>
												<th>Id User</th>
...
if( ! empty($penjualan)){
    ...
    foreach($penjualan as $data){
        echo "<tr>";
        echo "<td>".$data->pj_id."</td>";
        echo "<td>".$data->pj_tgl."</td>";
        echo "<td>".$data->pj_jam."</td>";
        echo "<td>".$data->pj_totitem."</td>";
        echo "<td>".$data->pj_cash."</td>";
        echo "<td>".$data->pj_kembali."</td>";
		echo "<td>".$data->usr_id."</td>";
        echo "</tr>";
        $no++;
    }
}
